...
| `❘r❘`, `s`, `s₂`, `p₁` <br> (& condition C)                        |⇔| oriented homeomorphism                   | [\[Kru05\]](#references) <br>[\[CEZ07, Thm&nbps;2.3\]](#references)  | 
|   |   |   |    |
...
| `❘r❘`, `❘s❘`, `❘s₂❘`,  `sign(s)·sign(s₂)`, `p₁` <br> (& condition C)                                        |⇔| homeomorphism                   | [\[Kru05\]](#references) <br>[\[CEZ07, Thm&nbps;2.3\]](#references)  | 
